...
const SearchBar = ({ onFilterChange }) => {
  ...
  return (
    <div className="flex flex-wrap justify-center gap-4 my-10 px-4 sm:px-10">
      <select
        className="w-full sm:w-48 py-3 pl-4 font-semibold rounded-md "
        name="role"
      ...
      <select
        className="w-full sm:w-56 py-3 pl-4 font-semibold rounded-md"
      ...
      <select
        className="w-full sm:w-40 py-3 pl-4 font-semibold rounded-md"
        name="experience"
        onChange={handleChange}
        style={{ color: 'gray' }}
      >
      ...
      <select
        className="w-full sm:w-32 py-3 pl-4 font-semibold rounded-md"
        name="remote"
        onChange={handleChange}
        style={{ color: 'gray' }}
      >
      ...
      <select
        className="w-full sm:w-60 py-3 pl-4 font-semibold rounded-md"
        name="minSalary"
        onChange={handleChange}
        style={{ color: 'gray' }}
      >
      ...
      <input
        type="text"
        placeholder="Search..."
        className=" py-3 pl-4 font-semibold  rounded-md border border-gray-300 focus:outline-none focus:ring focus:ring-blue-200"
